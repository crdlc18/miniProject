        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            <div class=" overflow-hidden shadow-sm sm:rounded-lg flex justify-center items-center bg-gray-200 light:bg-gray-400 ">
                <div class="p-6 bg-gray-100 text-gray-100 shadow-xl rounded px-8 pt-6 pb-8 mb-4 ">
                    <form method="post" action="{{ route('manageEmp.update', ['employee' => $employee]) }}" class="grid gap-2 px-4">
                        @csrf
                        @method('put')

                        <div class=" relative mb-2 mt-6 grid grid-cols-2"> 
                            <label class="text-left pr-4 font-bold text-gray-700">First Name :</label>
                            <input type="text" name="empFname" value="{{ $employee->empFname }}"
                                class="shadow appearance-non border rounded text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                        </div>
                        <div class="p-0 m-0">
                        ...
                        <div class="mb-2 grid grid-cols-2"> 
                            ...
                            <input type="text" name="empLname" value="{{ $employee->empLname }}"
                        ...
                        <div class="mb-2 grid grid-cols-2"> 
                            ...
                            <select name="gender" id="gender"
                                class="shadow appearance-non border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                <option value="0" @if ($employee->gender == '0') selected @endif>Select your gender</option>
                        ...
                        <div class="mb-2 grid grid-cols-2"> 
                            ...
                            <input type="date" name="birthday" value="{{ $employee->birthday }}" max="{{ now()->subYear()->endOfYear()->toDateString() }}"
                                class="shadow appearance-non border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                        </div>
                        <div class="p-0 m-0">
                        ...
                        <div class="mb-2 grid grid-cols-2">
                            ...
                            <input type="text" name="age" id="age" value="{{ $employee->age }}" readonly 
                                 class="shadow appearance-non border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                        </div>
                        <div class="p-0 m-0">
                        ...
                        <div class="mb-2 grid grid-cols-2"> 
                            ...
                            <input type="text" name="monthly_salary" value="{{ $employee->monthly_salary }}"
                                class="shadow appearance-non border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                        </div>
                        <div class="p-0 m-0">
